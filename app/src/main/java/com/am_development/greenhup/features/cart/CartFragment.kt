...
class CartFragment : Fragment(), CartView {
    ...
    private val cartList: MutableList<CartItem> = ArrayList()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val cartIte: MutableList<CartItem> = ArrayList()
        cartIte.add(CartItem("5","Grite",2, 50.0f, 100.0f, "https://h7h9j4n8.stackpathcdn.com/wp-content/uploads/2014/07/Classiс-plant-transparent.png",6))
        cartIte.add(CartItem("5","Grite",2, 50.0f, 100.0f, "https://h7h9j4n8.stackpathcdn.com/wp-content/uploads/2014/07/Classiс-plant-transparent.png",6))
        cartIte.add(CartItem("5","Grite",2, 50.0f, 100.0f, "https://h7h9j4n8.stackpathcdn.com/wp-content/uploads/2014/07/Classiс-plant-transparent.png",6))
        addToCartList(cartIte)
    ...
    override fun addToCartList(items: MutableList<CartItem>) {
        adapterCartItemsList?.addAll(items)
    }
}
