...
import com.openet.entities.KEY_CATEGORY_ID
...
class CategoryProductsActivity : BaseActivity(), CategoryProductsView, AdapterProducts.customButtonListener, PaginationAdapterCallBack {
